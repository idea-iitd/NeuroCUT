...
result_folder=f'../results/{args.train}_{args.embedding}_{args.anchors}_{args.norm}_{model_name}_{num_layers}_{args.modelScore}_{args.iter_update_params}_{args.initial_type}_{args.initial_order}_{args.scoring_func}_{args.node_select}_{num_perturbation}_{args.node_select_heuristic}_{args.pool}_{args.update_reward}_{args.hops}_{args.cuttype}_{args.gamma}_{args.alpha_reward}_{args.beta}_{args.lr}_finetune_{args.finetune_epochs}'
...
if wandb_flag:
    wandb.init(project="phase2_rl", name=f"{args.train}_{args.embedding}_{args.anchors}_{args.norm}_{model_name}_{num_layers}_{args.modelScore}_{args.iter_update_params}_{args.initial_type}_{args.initial_order}_{args.scoring_func}_{args.node_select}_{num_perturbation}_{args.node_select_heuristic}_{args.pool}_{args.update_reward}_{args.hops}_{args.cuttype}_{args.gamma}_{args.alpha_reward}_{args.beta}_{args.lr}_finetune_{args.finetune_epochs}", config=args,entity='mincuts')

model_folder=f'../models/{args.train}_{args.embedding}_{args.anchors}_{args.norm}_{model_name}_{num_layers}_{args.modelScore}_{args.iter_update_params}_{args.initial_type}__{args.initial_order}_{args.scoring_func}_{args.node_select}_{num_perturbation}_{args.node_select_heuristic}_{args.pool}_{args.update_reward}_{args.hops}_{args.cuttype}_{args.gamma}_{args.alpha_reward}_{args.beta}_{args.lr}_finetune_{args.finetune_epochs}'
...
def train(epoch,data_loader):  
    ...
    for _,data in enumerate(data_loader):
        ...
        for i in tqdm(range(int(num_nodes*num_perturbation))):
            ...
            # print("logits",logits)
            if (i%args.iter_update_params==0 and i!=0) or  i==int(num_nodes*num_perturbation)-1: ## TODO : do we need to update at end node
